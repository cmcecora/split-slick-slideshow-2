/**
 * Medical Tests Data - Parsed from CSV
 * Body parts organized by category with test mappings
 */
...
function getProcedureImage(testName) {
...
// Map existing test images to test names
const TEST_IMAGES = {
...
function getTestImage(testName, testType) {
...
// Get placeholder image based on test type
function getTestPlaceholder(type) {
  return `./images/placeholder-${type}.svg`;
}

// Filter tests by body part
function getTestsForBodyPart(bodyPart) {
...
function getCategoryForBodyPart(bodyPart) {
...
function getSystemForBodyPart(bodyPart) {
...
function getSystemIcon(system) {
  const icons = {
    'Cardiovascular': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>',
    'Nervous': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/></svg>',
    'Respiratory': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v8M8 6c0 7-6 8-6 12a4 4 0 0 0 4 4h12a4 4 0 0 0 4-4c0-4-6-5-6-12"/><path d="M8 18h8"/></svg>',
    'Endocrine': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M12 12v4M8 20h8M10 16h4"/></svg>',
    'Digestive': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2c-4 0-6 3-6 6s2 4 2 8c0 2-1 4-1 6h10c0-2-1-4-1-6 0-4 2-5 2-8s-2-6-6-6z"/></svg>',
    'Excretory': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><ellipse cx="12" cy="9" rx="6" ry="4"/><path d="M6 9v8c0 2 2.5 4 6 4s6-2 6-4V9"/></svg>',
    'Immune': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L4 6v6c0 5.5 3.5 10 8 11 4.5-1 8-5.5 8-11V6l-8-4z"/><path d="M9 12l2 2 4-4"/></svg>',
    'Integumentary': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>',
    'Muscular': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 4c0 0-2 2-2 6s2 6 2 6M18 4c0 0 2 2 2 6s-2 6-2 6"/><path d="M6 10h12M8 7v6M16 7v6"/></svg>',
    'Skeletal': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="4" r="2"/><path d="M12 6v4M8 10h8M10 14h4M12 10v8M8 22l4-4 4 4"/></svg>',
    'Reproductive Female': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="5"/><path d="M12 13v8M9 18h6"/></svg>',
    'Reproductive Male': '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="10" cy="14" r="5"/><path d="M14.5 9.5L19 5M19 5h-5M19 5v5"/></svg>'
  };
  return icons[system] || '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle></svg>';
}
